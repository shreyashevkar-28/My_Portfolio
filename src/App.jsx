...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .navbar {
    ...
    border-bottom: 1px solid rgba(14,165,233,0.50);
  }
  .navbar-inner {
    max-width: 1100px;
    margin: 0 auto;
  ...
  .home-role { font-size: 1rem; color: #64748b; margin-bottom: 1.1rem; }
  ...
  .about-text p { font-size: 0.93rem; line-height: 1.9; color: #94a3b8; margin-bottom: 0.85rem; }
  ...
  /* ─── SKILLS ─── */
  .skills-grid { display: grid; grid-template-columns: repeat(2,1fr); gap: 1.1rem; text-align: left; }
  .skill-card {
  ...
  .skill-header { display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.8rem; }
  .skill-icon { font-size: 1.8rem; line-height: 1; flex-shrink: 0; }
  .skill-title { font-size: 0.9rem; font-weight: 700; color: #38bdf8; text-transform: uppercase; letter-spacing: 0.08em; }
  ...
  /* ─── PROJECTS ─── */
  .projects-grid { display: flex; flex-direction: column; gap: 1.5rem; width: 100%; text-align: left; }
  .project-card {
    background: rgba(255,255,255,0.02);
    border: 1px solid rgba(255,255,255,0.06);
  ...
  .project-body { width: 70%; padding: 1.4rem 1.75rem; }
  .project-number {
    font-size: 0.8rem;
    font-weight: 700;
  ...
  .project-desc { font-size: 1rem; line-height: 1.7; color: #64748b; }


  /* ─── CERTIFICATES ─── */
  .certs-grid { display: grid; grid-template-columns: repeat(3,1fr); gap: 1.1rem; width: 100%; text-align: left; }
  .cert-card {
    background: rgba(255,255,255,0.02);
    border: 1px solid rgba(255,255,255,0.06);
  ...
  .cert-body { padding: 1.4rem 0.95rem; }
  .cert-name { font-size: 1rem; font-weight: 500; color: #e2e8f0; margin-bottom: 0.45rem; line-height: 1.4; }
  .cert-link {
    font-size: 0.8rem;
    font-weight: 600;
    color: #6366f1;
  ...
  .contact-cards { display: grid; grid-template-columns: repeat(2,1fr); gap: 0.7rem; width: 100%; max-width: 800px; }
  .contact-item {
    background: rgba(255,255,255,0.02);
    border: 1px solid rgba(255,255,255,0.06);
    border-radius: 0.7rem;
  ...
  .contact-type { font-size: 1.1rem; font-weight: 700; color: #38bdf8; text-transform: uppercase; letter-spacing: 0.11em; margin-bottom: 0.1rem; }
  .contact-val { font-size: 0.9rem; color: #94a3b8; word-break: break-all; }


  /* ─── DIVIDER ─── */
  .divider { max-width: 1100px; margin: 0 auto; height: 1px; background: rgba(255,255,255,0.04); }


  /* ─── FOOTER ─── */
  .footer { border-top: 1px solid rgba(255,255,255,0.04); padding: 1.5rem 2rem; text-align: center; font-size: 0.75rem; color: #334155; }
  ...
  @media (max-width: 768px) {
    .home-section { flex-direction: column; text-align: center; min-height: auto; padding: 3rem 1.5rem; gap: 2rem; justify-content: flex-start; }
        ...
        <nav className="navbar">
          <div className="navbar-inner">
            ...
            <ul className="nav-links">
              {navItems.map(id => (
                <li key={id}>
                  <Link to={id} smooth duration={500} offset={-72} spy className="nav-link">
          ...
          <div className="home-section">
            ...
            <div className="home-text">
              ...
              <div className="home-cta">
                <Link to="projects" smooth duration={500} offset={-72} className="btn-primary">View Projects ↓</Link>
                <Link to="contact"  smooth duration={500} offset={-72} className="btn-outline">Get in Touch</Link>
              </div>
            </div>
          </div>
        </section>
